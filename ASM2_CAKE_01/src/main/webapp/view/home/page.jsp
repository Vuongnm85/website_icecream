...
<body id="home">
		...
		<div class="container_fullwidth">
			<div class="container">
				<div class="hot-products">
					...
					<div class="control">
						<a id="prev_hot" class="prev"
							href="/product/page?p=${page.number+1}">&lt;</a> <a id="next_hot"
							class="next" href="/product/page?p=${page.number-1}">&gt;</a>
					</div>
					<ul id="hot">
						<li>
							<div class="row">
										...
										<div class="products">
											...
											<div class="thumbnail">
												<a href="/cart/detail/${item.id }"><img
													src="/view/home/adam_img/${item.image}" alt="Product Name"
							...
							</div> <a href="/product/page?p=0"><button class="button add-cart"
									type="button">First</button></a> <a
							href="/product/page?p=${page.number-1}"><button
									class="button add-cart" type="button">Previous</button></a> <a
							href="/product/page?p=${page.number+1}"><button
									class="button add-cart" type="button">Next</button></a> <a
							href="/product/page?p=${page.totalPages-1}"><button
									class="button add-cart" type="button">Last</button></a>
	...
	<script type="text/javascript"
		src="/view/home/js/jquery.sequence-min.js"></script>
	<script type="text/javascript"
