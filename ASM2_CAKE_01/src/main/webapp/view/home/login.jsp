...
<body>
						...
						<div class="checkout-page">
							<ol class="checkout-steps">
								<li class="steps active"><a href="checkout.html"
									class="step-title"> 01. checkout opition </a>
												...
												<div class="run-customer">
													...
													<form action="/account/login" method="post"
														...
														username: <input type="text"
															class="input namefild" name="username"> <br />
															<br />
														password: <input type="text" class="input namefild"
															name="password"> <br /> 
														<input type="checkbox"
															name="remember" value="true"> Remember ? <br />
														<button>Login</button>
													</form>
												</div>
											</div>
								...
								<li class="steps"><a href="checkout2.html"
									class="step-title"> 02. billing information </a></li>
								<li class="steps"><a href="checkout2.html"
									class="step-title"> 03. Shipping information </a></li>
								<li class="steps"><a href="#" class="step-title"> 04.
										shipping method </a></li>
								<li class="steps"><a href="#" class="step-title"> 05.
										payment information </a></li>
								<li class="steps"><a href="#" class="step-title"> 06.
										oder review </a></li>
							</ol>
						</div>
					</div>
	...
	<script type="text/javascript" src="/view/home/js/jquery-1.10.2.min.js">
		
	</script>
	<script type="text/javascript" src="/view/home/js/bootstrap.min.js">
		
	</script>
	<script defer src="/view/home/js/jquery.flexslider.js">
		
	</script>
	<script type="text/javascript"
		src="/view/home/js/jquery.carouFredSel-6.2.1-packed.js">
		
	</script>
	<script type="text/javascript" src="/view/home/js/script.min.js">
