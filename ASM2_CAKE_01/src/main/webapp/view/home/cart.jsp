						...
						<div class="header_bottom">
									...
									<ul class="option-cart-item">
										<c:forEach var="item" items="${cart.items}">
											<li>
												<div class="cart-item">
													<div class="image">
														<img src="/view/home/adam_img/${item.image}"
															alt="">
													</div>
													<div class="item-description">
														...
														<p>
															...
															Quantity: <span class="light-red"> ${item.qty} </span>
														</p>
													</div>
													<div class="right">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									<li class="active dropdown"><a href="/product/page"
						...
						<table class="shop-table">
							...
							<tbody>
								<c:forEach var="item" items="${cart.items}">
									...
									<tr>
										<td><img
											src="/view/home/adam_img/${item.image}" alt=""></td>
										...
										<td><input aria-label="quantity" class="input-qty"
											min="1" name="qty" type="number" value="${item.qty}">
										</td>

										<td>
											<h5>
												<strong class="red"> ${item.price * item.qty} </strong>
											</h5>
										</td>

										<td><a href="/cart/remove/${item.id}"> <img
												src="/view/home/images/remove.png" alt="">
										</a></td>
