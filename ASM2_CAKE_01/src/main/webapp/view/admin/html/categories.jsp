						...
						<div class="card">
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane active" id="home" role="tabpanel">
									<div class="card">
										<form:form action="/admin/categories/index"
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="id" type="text" class="form-control"
															id="fname" placeholder="Mã danh mục" />
													</div>
												</div>
												<div class="form-group row">
													<label for="lname"
													...
													<div class="col-sm-9">
														<form:input path="name" type="text" class="form-control"
															id="lname" placeholder="Tên danh mục" />
													</div>
												</div>
											</div>
											<div class="border-top">
												<div class="card-body">
													<button class="btn btn-primary"
														formaction="/admin/categories/create">Thêm</button>
													<button class="btn btn-success text-white"
														formaction="/admin/categories/update">Cập nhật</button>
													<button class="btn btn-danger text-white"
														formaction="/admin/categories/delete/${item.id}">Xoá</button>
													<button class="btn btn-link text-decoration-none"
														formaction="/admin/categories/index">Reset</button>
												</div>
											</div>
										</form:form>
									</div>
