			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title">
							<b>TÀI KHOẢN ${fullname }</b> ${message }
						</h4>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="row">
							<div class="col-lg-3">
								<img src="/view/admin/assets/images/users/${photo }" width="">
							</div>
							<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<form:input path="username" type="text" class="form-control"
													id="fname" placeholder="Tên đầy đủ" />
											</div>
										</div>
										<div class="form-group row">
											<label for="fname"
									...
									<div class="border-top">
										<div class="card-body">
											<button class="btn btn-success text-white"
												formaction="/admin/myaccount/update">Cập nhật</button>
										</div>
									</div>
								</form:form>
							</div>
