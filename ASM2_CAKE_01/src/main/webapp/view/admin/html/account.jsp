			...
			<nav class="navbar top-navbar navbar-expand-md navbar-dark">
				<div class="navbar-header" data-logobg="skin5">
					...
					<a class="navbar-brand" href="index.html"> <!-- Logo icon --> <b
						...
						<!-- Dark Logo icon --> <!-- <img src="/view/admin/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
							...
							<ul class="nav nav-tabs" role="tablist">
								<li class="nav-item"><a class="nav-link active"
									data-bs-toggle="tab" href="#home" role="tab"><span
										class="hidden-sm-up"></span> <span class="hidden-xs-down">Tài
											khoản</span></a></li>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="username" type="text"
															class="form-control" id="fname" placeholder="Tên đầy đủ" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname"
														class="col-sm-3 text-end control-label col-form-label">Mật
														khẩu</label>
													<div class="col-sm-9">
														<form:input path="password" type="text"
															class="form-control" id="fname" placeholder="Mật khẩu" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname"
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="email" type="text" class="form-control"
															id="fname" placeholder="Email" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname"
														class="col-sm-3 text-end control-label col-form-label">Ảnh
														đại diện</label>
													<div class="col-sm-9">
														<form:input path="photo" type="text" class="form-control"
															id="fname" placeholder="Ảnh đại diện" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname"
														class="col-sm-3 text-end control-label col-form-label">Vai
														trò</label>
													<div class="col-sm-9">
														<form:input path="admin" type="text" class="form-control"
															id="fname" placeholder="Vai trò" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname"
													...
													<div class="col-sm-9">
														<form:input path="activated" type="text"
															class="form-control" id="fname" placeholder="Trạng thái" />
													</div>
												</div>
											</div>
											<div class="border-top">
												<div class="card-body">
													...
													<button class="btn btn-danger text-white"
														formaction="/admin/account/delete/${item.username}">Xoá</button>
													<button class="btn btn-link text-decoration-none"
														formaction="/admin/account/index">Reset</button>
												</div>
											</div>
										</form:form>
									</div>
														...
														<c:forEach var="item" items="${items}">
															<tr>
																...
																<td style="color: blue;"><a
																	href="/admin/account/edit/${item.username}"><i
																		class="me-2 mdi mdi-border-color"
																		style="margin-left: 35%"></i></a></td>
																<td style="color: red;"><a
																	href="/admin/account/delete/${item.username }"><i
